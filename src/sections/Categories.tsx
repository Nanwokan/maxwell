...
const Categories = ({ categories = defaultPublicHomepageData.categories }: CategoriesProps) => {
  ...
  return (
    <section
      ref={sectionRef}
      id="categories"
      className="section-pinned relative z-30 flex flex-col justify-center bg-[#0B0F17]"
    >
      <div ref={headlineRef} className="mb-8 px-8 lg:px-[8vw]">
      ...
      <div
        ...
        className="scrollbar-hide flex gap-6 overflow-x-auto px-8 pb-4 lg:px-[8vw]"
        style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
      >
        {categories.map((category) => (
          <div
            key={category._id ?? category.code}
            className="hover-lift group h-[380px] w-[280px] flex-shrink-0 cursor-pointer overflow-hidden rounded-2xl bg-[#121A26] lg:h-[420px] lg:w-[320px]"
          >
            <div
            ...
            >
              ...
              <span className="relative z-10 text-6xl font-extrabold text-white lg:text-7xl">
                {category.title}
              </span>
            </div>
